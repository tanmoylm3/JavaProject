...
PreparedStatement pstmt=connection.prepareStatement(QueryInterface.FetchStudentDetailsSQL);
pstmt.setString(1, id);
ResultSet rs = null;
rs = pstmt.executeQuery();
while(rs.next()){
String sem =rs.getString("SEMESTER");
session.setAttribute("SESS_STU_SEM",sem);
}
...
%>
    ...
    <div id="wrapper" style="background: #2C6E8B">
      ...
      <!--       <li class="nav-item active">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="subjects.jsp" >
